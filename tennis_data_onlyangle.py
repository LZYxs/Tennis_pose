...
if __name__ == '__main__':
    ...
    counter = 0
    stage = None
    dir_path = "D:\\tennis_image\\prepare"
    ...
    for file in files:
        ...
        with mp_pose.Pose(min_detection_confidence=0.3, min_tracking_confidence=0.8) as pose:
            ...
            try:
                ...
                #print(rangle, " ", langle)
                test.append(
                    [langle, rangle, lsangle, rsangle, lhangle, rhangle, lkangle, rkangle,newdis,3])
                #print(test)
    ...
    column = ['langle', 'rangle', 'lsangle', 'rsangle', 'lhangle', 'rhangle', 'lkangle',
              'rkangle','newdis','class']  # 列表头名称,9个特征1个分类
